...
namespace KeepAliveHD.Forms
{
    public partial class Main : Form
    {
            ...
            if ( Directory.Exists( driveInfo.Drive ) && ( ignoreVolumeNames == true || ( ignoreVolumeNames == false && driveInfo.VolumeNames.Contains( volumeName ) ) ) )
            {
                try
                {
                    ...
                    else
                    {
                        ...
                        using ( var writer = new StreamWriter( sFileName, false, Encoding.ASCII ) )
                        {
        ...
        private void FillSettings()
        {
            ...
            SetEngineStatus( ApplicationConfiguration.WritingEnabled ? EngineStatus.Started : EngineStatus.Stopped );
