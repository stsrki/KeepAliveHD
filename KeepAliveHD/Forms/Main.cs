...
namespace KeepAliveHD.Forms
{
    public partial class Main : Form
    {
        ...
        private void WriteKeepAliveFile( string fileName )
        {
            string text = "This file was generated by KeepAliveHD application on " + DateTime.Now.ToString();
            byte[] data = Encoding.ASCII.GetBytes( text );

            if ( AppConfiguration.SafeWriting )
            {
