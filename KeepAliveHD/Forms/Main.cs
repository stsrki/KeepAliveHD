    ...
    public partial class Main : Form
    {
        ...
        public Main( bool minimize )
        {
            ...
            try
            {
                ...
                InitialiseTimers( chkWritingEnabled.Checked );
        ...
        private void WriteFile( Database.DriveInfo driveInfo )
        {
        ...
        private void dgDrives_SelectionChanged( object sender, EventArgs e )
        {
            ...
            else
            {
                ...
                if ( row.Cells[DriveStatus.Index].Value.ToString() == "0" )
                    ...
                    row.DefaultCellStyle.SelectionForeColor = chkWritingEnabled.Checked ? Color.Green : Color.Blue;
            }
        ...
        private void dgDrives_RowsAdded( object sender, DataGridViewRowsAddedEventArgs e )
        {
            foreach ( DataGridViewRow row in dgDrives.Rows )
            {
                if ( row.Cells[DriveStatus.Index].Value.ToString() == "0" )
                    ...
                    row.DefaultCellStyle.ForeColor = chkWritingEnabled.Checked ? Color.Green : Color.Blue;
            }
        }
        ...
        private void chkWritingEnabled_CheckedChanged( object sender, EventArgs e )
        {
            if ( chkWritingEnabled.ContainsFocus )
            {
                ApplicationConfiguration.WritingEnabled = chkWritingEnabled.Checked;
                InitialiseTimers( chkWritingEnabled.Checked );
                LoadDrives();
            }
        }
        ...
        {
            Database.DatabaseManager.FillDrives( dgDrives, chkWritingEnabled.Checked );
        ...
        private void FillSettings()
        {
            ...
            chkWritingEnabled.Checked = ApplicationConfiguration.WritingEnabled;
